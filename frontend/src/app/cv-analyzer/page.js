        ...
        <AnimatePresence mode="wait">
          ...
          {!isUploading && !result && (
            ...
            >
              <div
                {...getRootProps()}
                className={`w-full max-w-xl mx-auto p-12 border-2 border-dashed rounded-3xl cursor-pointer transition-all duration-300 relative overflow-hidden group ${ isDragActive ? "border-primary bg-primary/10 scale-105" : "border-primary/30 hover:border-primary/60 hover:bg-primary/5 hover:shadow-[0_0_30px_rgba(var(--primary),0.1)]" }`}
